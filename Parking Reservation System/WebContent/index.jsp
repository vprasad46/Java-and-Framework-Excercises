...
%>
 ...
 <html:form action="/choice">
	 <html:radio name="choiceForm" 
	  property="choice" value="BookTicket" >Book Parking Ticket</html:radio>
	 <html:radio name="choiceForm" 
	 property="choice" value="Checkout">Checkout</html:radio>
	 <html:radio name="choiceForm" 
	 property="choice" value="Floor">Floor Slots</html:radio>
	 <html:radio name="choiceForm" 
	 property="choice" value="Basement">Basement Slots</html:radio>
 	 <html:submit/>
 </html:form>
</body>
</html>